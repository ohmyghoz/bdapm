...
{
    [Area("Dashboard")]
    public class DetailFrekuensiAktivitasController : Controller
    {
        private DataEntities db;
        private IWebHostEnvironment _env;

        public DetailFrekuensiAktivitasController(DataEntities db, IWebHostEnvironment env)
        {
            this.db = db;
            _env = env;
        }
        ...
        public IActionResult Index()
        {
            ...
            db.CheckPermission("Detail Frekuensi Aktivitas View", DataEntities.PermissionMessageType.ThrowInvalidOperationException);
            //var roleId = HttpContext.User.FindFirst(ClaimTypes.Role).Value;
            //ViewBag.Akses = roleId;
            ViewBag.Export = db.CheckPermission("Detail Frekuensi Aktivitas Export", DataEntities.PermissionMessageType.NoMessage);

            db.InsertAuditTrail("DetailFrekuensiAktivitas_Akses_Page", "Akses Page Dashboard Detail Frekuensi Aktivitas", pageTitle);
        ...
        public IActionResult LogExportIndex()
        {
            try
            {
                ...
                db.CheckPermission("Detail Frekuensi Aktivitas Export", DataEntities.PermissionMessageType.ThrowInvalidOperationException);
                db.InsertAuditTrail("ExportIndex_DetailFrekuensiAktivitas", "Export Data", pageTitle);
        ...
        public IActionResult ExportPDF(IFormFile file)
        {
            try
            {
                ...
                var fileName = "DetailFrekuensiAktivitas_" + timeStamp + ".pdf";
        ...
        public object GetGridData(DataSourceLoadOptions loadOptions, string memberTypes, string members, string periodeAwal, string periodeAkhir, string status)
        {
            ...
            var query = db.getLogOutliersDetail(stringMemberTypes, stringMembers, stringPeriodeAwal, stringPeriodeAkhir, stringStatus).ToList();
