...
{
    [Area("Dashboard")]
    public class KomposisiJarakAntarAktivitasController : Controller
    {
        private DataEntities db;
        private IWebHostEnvironment _env;

        public KomposisiJarakAntarAktivitasController(DataEntities db, IWebHostEnvironment env)
        {
            this.db = db;
            _env = env;
        }
        ...
        public IActionResult Index()
        {
            ...
            db.CheckPermission("Komposisi Jarak Antar Aktivitas View", DataEntities.PermissionMessageType.ThrowInvalidOperationException);
            //var roleId = HttpContext.User.FindFirst(ClaimTypes.Role).Value;
            //ViewBag.Akses = roleId;
            ViewBag.Export = db.CheckPermission("Komposisi Jarak Antar Aktivitas Export", DataEntities.PermissionMessageType.NoMessage);

            db.InsertAuditTrail("KomposisiJarakAntarAktivitas_Akses_Page", "Akses Page Dashboard Komposisi Jarak Antar Aktivitas", pageTitle);
        ...
        public IActionResult LogExportIndex()
        {
            try
            {
                ...
                db.CheckPermission("Komposisi Jarak Antar Aktivitas Export", DataEntities.PermissionMessageType.ThrowInvalidOperationException);
                db.InsertAuditTrail("ExportIndex_KomposisiJarakAntarAktivitas", "Export Data", pageTitle);
        ...
        public IActionResult ExportPDF(IFormFile file)
        {
            try
            {
                ...
                var fileName = "KomposisiJarakAntarAktivitas_" + timeStamp + ".pdf";
        ...
        public object GetGridData(DataSourceLoadOptions loadOptions, string memberTypes, string members, string periodeAwal, string periodeAkhir)
        {
            ...
            var query = db.getLogOutliersAvgKomposisi(stringMemberTypes, stringMembers, stringPeriodeAwal, stringPeriodeAkhir).ToList();
