    ...
    SelectFx.prototype._createSelectEl = function() {
        var self = this,
            ...
            createOptionHTML = function(el) {
                ...
                return '<li ' + optclass + link + ' data-option data-value="' + el.value + '"><span><a href="'+ el.value +'">' + el.textContent + '</a></span></li>';
            };
 ...
 * Pages Chat
 * ============================================================ */
/* Fortify : Disabled, tidak perlu juga
(function($) {
  'use strict';
...
(function($) {
    ...
    var Progress = function(element, options) {
        ...
        var deg = convertpercentagetodegrees(this.val);
    ...
    Progress.prototype.value = function(val) {
        ...
        var deg = convertpercentagetodegrees(val);
    ...
    function convertpercentagetodegrees(p) {
...
(function($) {
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
         ...
         // Toggle sidebar
         $('.sidebar-slide-toggle').on('click', function(e) {
             e.preventDefault();
             $(this).toggleClass('active');
