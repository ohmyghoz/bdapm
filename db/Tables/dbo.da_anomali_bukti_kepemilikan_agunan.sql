CREATE TABLE [dbo].[da_anomali_bukti_kepemilikan_agunan]
(
...
GO
ALTER TABLE [dbo].[da_anomali_bukti_kepemilikan_agunan] ADD CONSTRAINT [PK_da_anomali_bukti_kepemilikan_agunan] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
