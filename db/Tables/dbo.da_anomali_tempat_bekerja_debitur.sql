CREATE TABLE [dbo].[da_anomali_tempat_bekerja_debitur]
(
...
GO
ALTER TABLE [dbo].[da_anomali_tempat_bekerja_debitur] ADD CONSTRAINT [PK_da_anomali_tempat_bekerja_debitur] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
