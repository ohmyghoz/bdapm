CREATE TABLE [dbo].[osida_hapusbuku_satu_tahun]
(
...
[dm_jumlah_bulan_dari_akad_akhir] [float] NULL,
...
GO
ALTER TABLE [dbo].[osida_hapusbuku_satu_tahun] ADD CONSTRAINT [PK_osida_hapusbuku_satu_tahun] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
