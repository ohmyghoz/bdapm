CREATE TABLE [dbo].[da_anomali_bentuk_badan_usaha]
(
...
GO
ALTER TABLE [dbo].[da_anomali_bentuk_badan_usaha] ADD CONSTRAINT [PK_da_anomali_bentuk_badan_usaha] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
