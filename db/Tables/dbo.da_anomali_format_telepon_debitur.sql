CREATE TABLE [dbo].[da_anomali_format_telepon_debitur]
(
...
[dm_telepon] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_telepon_selular] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[da_anomali_format_telepon_debitur] ADD CONSTRAINT [PK_da_anomali_format_telepon_debitur] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
