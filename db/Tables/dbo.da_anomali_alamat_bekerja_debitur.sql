CREATE TABLE [dbo].[da_anomali_alamat_bekerja_debitur]
(
...
[dm_alamat_tempat_bekerja] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_kode_anomali] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[da_anomali_alamat_bekerja_debitur] ADD CONSTRAINT [PK_da_anomali_alamat_bekerja_debitur] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
