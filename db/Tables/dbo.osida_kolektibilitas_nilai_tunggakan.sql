CREATE TABLE [dbo].[osida_kolektibilitas_nilai_tunggakan]
(
...
[dm_baki_debet_m2] [decimal] (38, 6) NULL,
...
GO
ALTER TABLE [dbo].[osida_kolektibilitas_nilai_tunggakan] ADD CONSTRAINT [PK_osida_kolektibilitas_nilai_tunggakan] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
