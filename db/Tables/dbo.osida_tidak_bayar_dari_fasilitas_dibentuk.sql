CREATE TABLE [dbo].[osida_tidak_bayar_dari_fasilitas_dibentuk]
(
...
[dm_jml_hari_fasilitas] [int] NULL,
...
GO
ALTER TABLE [dbo].[osida_tidak_bayar_dari_fasilitas_dibentuk] ADD CONSTRAINT [PK_osida_tidak_bayar_dari_fasilitas_dibentuk] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
