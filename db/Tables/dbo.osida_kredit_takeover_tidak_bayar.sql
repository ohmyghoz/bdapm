CREATE TABLE [dbo].[osida_kredit_takeover_tidak_bayar]
(
...
[dm_takeover_dari] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_jumlah_hari_setelah_takeover] [int] NULL,
...
GO
ALTER TABLE [dbo].[osida_kredit_takeover_tidak_bayar] ADD CONSTRAINT [PK_osida_kredit_takeover_tidak_bayar] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
