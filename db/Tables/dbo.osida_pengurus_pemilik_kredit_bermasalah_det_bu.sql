CREATE TABLE [dbo].[osida_pengurus_pemilik_kredit_bermasalah_det_bu]
(
...
GO
ALTER TABLE [dbo].[osida_pengurus_pemilik_kredit_bermasalah_det_bu] ADD CONSTRAINT [PK_osida_pengurus_pemilik_kredit_bermasalah_det_bu] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
