CREATE TABLE [dbo].[osida_kredit_macet_tdk_hb_det]
(
...
[dm_nilai_agunan_penilai_independen] [decimal] (38, 6) NULL
)
GO
ALTER TABLE [dbo].[osida_kredit_macet_tdk_hb_det] ADD CONSTRAINT [PK_osida_kredit_macet_tdk_hb_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
