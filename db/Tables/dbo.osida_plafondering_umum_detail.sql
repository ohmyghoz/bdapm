CREATE TABLE [dbo].[osida_plafondering_umum_detail]
(
...
[dm_kode_operasi] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[osida_plafondering_umum_detail] ADD CONSTRAINT [PK_osida_plafondering_umum_detail] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
