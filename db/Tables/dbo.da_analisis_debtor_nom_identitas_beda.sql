CREATE TABLE [dbo].[da_analisis_debtor_nom_identitas_beda]
(
...
[dm_nama_gadis_ibu_kandung] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[da_analisis_debtor_nom_identitas_beda] ADD CONSTRAINT [PK_da_analisis_debtor_nom_identitas_beda] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
