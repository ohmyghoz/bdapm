CREATE TABLE [dbo].[osida_plafondering_prk_dengan_plafon]
(
...
GO
ALTER TABLE [dbo].[osida_plafondering_prk_dengan_plafon] ADD CONSTRAINT [PK_osida_plafondering_prk_dengan_plafon] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
