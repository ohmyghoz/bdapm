CREATE TABLE [dbo].[osida_pemberian_kur_deb_noneligible_det]
(
...
GO
ALTER TABLE [dbo].[osida_pemberian_kur_deb_noneligible_det] ADD CONSTRAINT [PK_osida_pemberian_kur_deb_noneligible_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
