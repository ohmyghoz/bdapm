CREATE TABLE [dbo].[osida_kolektibilitas_jatuh_tempo]
(
...
GO
ALTER TABLE [dbo].[osida_kolektibilitas_jatuh_tempo] ADD CONSTRAINT [PK_osida_kolektibilitas_jatuh_tempo] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
