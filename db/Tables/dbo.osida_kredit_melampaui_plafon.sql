CREATE TABLE [dbo].[osida_kredit_melampaui_plafon]
(
...
[dm_plafon_bulan_lalu] [decimal] (38, 6) NULL,
...
[dm_percent_baki_debet] [decimal] (38, 6) NULL,
[dm_threshold_baki_debet] [decimal] (38, 6) NULL,
[dm_status_pencairan_lebih_besar_dari_baki_debet] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
ALTER TABLE [dbo].[osida_kredit_melampaui_plafon] ADD CONSTRAINT [PK_osida_kredit_melampaui_plafon] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
