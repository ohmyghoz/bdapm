CREATE TABLE [dbo].[osida_alih_deb_ke_bank_det]
(
...
[dm_baru_perpanjangan] [decimal] (38, 6) NULL,
...
GO
ALTER TABLE [dbo].[osida_alih_deb_ke_bank_det] ADD CONSTRAINT [PK_osida_alih_deb_ke_bank_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
