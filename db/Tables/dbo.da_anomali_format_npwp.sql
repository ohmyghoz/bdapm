CREATE TABLE [dbo].[da_anomali_format_npwp]
(
...
GO
ALTER TABLE [dbo].[da_anomali_format_npwp] ADD CONSTRAINT [PK_da_anomali_format_npwp] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
