CREATE TABLE [dbo].[da_anomali_alamat_email_debitur]
(
...
[dm_npwp] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_nama_id_debitur] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_alamat_email] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[da_anomali_alamat_email_debitur] ADD CONSTRAINT [PK_da_anomali_alamat_email_debitur] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
