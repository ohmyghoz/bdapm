CREATE TABLE [dbo].[agunan_dokumen_anomali]
(
...
[dm_jenis_segmen_fasilitas] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[dm_diasuransikan] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[agunan_dokumen_anomali] ADD CONSTRAINT [PK_agunan_dokumen_anomali] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
