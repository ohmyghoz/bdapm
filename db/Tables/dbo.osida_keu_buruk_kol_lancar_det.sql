CREATE TABLE [dbo].[osida_keu_buruk_kol_lancar_det]
(
...
GO
ALTER TABLE [dbo].[osida_keu_buruk_kol_lancar_det] ADD CONSTRAINT [PK_osida_keu_buruk_kol_lancar_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
