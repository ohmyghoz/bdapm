CREATE TABLE [dbo].[osida_info_keu_tdk_update_mst]
(
...
[dm_posisi_laporan_keuangan_terakhir] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_kualitas_terburuk] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[osida_info_keu_tdk_update_mst] ADD CONSTRAINT [PK_osida_info_keu_tdk_update_mst] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
