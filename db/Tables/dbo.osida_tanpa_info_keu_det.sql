CREATE TABLE [dbo].[osida_tanpa_info_keu_det]
(
...
GO
ALTER TABLE [dbo].[osida_tanpa_info_keu_det] ADD CONSTRAINT [PK_osida_tanpa_info_keu_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
