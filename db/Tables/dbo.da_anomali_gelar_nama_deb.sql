CREATE TABLE [dbo].[da_anomali_gelar_nama_deb]
(
...
[dm_spouse_name] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_mother_maiden_name] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[da_anomali_gelar_nama_deb] ADD CONSTRAINT [PK_da_anomali_gelar_nama_deb] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
