CREATE TABLE [dbo].[osida_potensi_konversi_kur_deb_noneligible_det]
(
...
[dm_program_pemerintah] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dm_tanggal_mulai] [date] NULL,
[dm_tanggal_jatuh_tempo] [date] NULL,
[dm_tanggal_awal_kredit] [date] NULL,
[dm_baru_perpanjangan] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[osida_potensi_konversi_kur_deb_noneligible_det] ADD CONSTRAINT [PK_osida_potensi_konversi_kur_deb_noneligible_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
