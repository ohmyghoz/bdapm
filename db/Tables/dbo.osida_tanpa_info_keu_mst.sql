CREATE TABLE [dbo].[osida_tanpa_info_keu_mst]
(
...
[dm_plafon_awal_fasilitas_terbesar] [decimal] (38, 6) NULL,
[dm_total_plafon] [decimal] (38, 6) NULL,
[dm_total_baki_debet] [decimal] (38, 6) NULL
)
GO
ALTER TABLE [dbo].[osida_tanpa_info_keu_mst] ADD CONSTRAINT [PK_osida_tanpa_info_keu_mst] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
