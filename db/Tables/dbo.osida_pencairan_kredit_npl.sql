CREATE TABLE [dbo].[osida_pencairan_kredit_npl]
(
...
[dm_status_pencairan_lebih_besar_dari_baki_debet] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
ALTER TABLE [dbo].[osida_pencairan_kredit_npl] ADD CONSTRAINT [PK_osida_pencairan_kredit_npl] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
