CREATE TABLE [dbo].[osida_perubahan_akad_no_restrukturisasi]
(
...
[dm_tanggal_mulai_m1] [date] NULL,
[dm_tanggal_jatuh_tempo] [date] NOT NULL,
[dm_tanggal_jatuh_tempo_m1] [date] NULL,
...
[dm_plafon_awal_m1] [decimal] (38, 6) NULL,
[dm_plafon] [decimal] (38, 6) NULL,
[dm_baki_debet] [decimal] (38, 6) NULL,
[dm_pencairan_bulan_berjalan] [decimal] (38, 6) NULL,
...
[dm_frekuensi_restrukturisasi] [int] NULL,
...
GO
ALTER TABLE [dbo].[osida_perubahan_akad_no_restrukturisasi] ADD CONSTRAINT [PK_osida_perubahan_akad_no_restrukturisasi] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
