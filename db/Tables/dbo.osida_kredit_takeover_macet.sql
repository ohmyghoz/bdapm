CREATE TABLE [dbo].[osida_kredit_takeover_macet]
(
...
GO
ALTER TABLE [dbo].[osida_kredit_takeover_macet] ADD CONSTRAINT [PK_osida_kredit_takeover_macet] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
