CREATE TABLE [dbo].[da_anomali_alamat_deb]
(
...
[dm_alamat] [varchar] (500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[da_anomali_alamat_deb] ADD CONSTRAINT [PK_da_anomali_alamat_deb] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
