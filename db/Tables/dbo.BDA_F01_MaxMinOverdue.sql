CREATE TABLE [dbo].[BDA_F01_MaxMinOverdue]
(
...
GO
ALTER TABLE [dbo].[BDA_F01_MaxMinOverdue] ADD CONSTRAINT [PK_BDA_F01_MaxMinOverdue] PRIMARY KEY CLUSTERED ([rowid]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
