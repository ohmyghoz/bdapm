CREATE TABLE [dbo].[osida_restrukturisasi_satu_tahun]
(
...
[dm_tanggal_akad_akhir] [date] NULL,
[dm_jumlah_bulan_dari_akad_awal] [int] NULL,
...
[dm_tanggal_restru_awal] [date] NULL,
[dm_freq_restrukturisasi] [int] NULL,
...
GO
ALTER TABLE [dbo].[osida_restrukturisasi_satu_tahun] ADD CONSTRAINT [PK_osida_restrukturisasi_satu_tahun] PRIMARY KEY CLUSTERED ([dm_periode], [rowid]) WITH (FILLFACTOR=80) ON [PartitionTable_ByYearMonthDateScheme_BDAP] ([dm_periode])
GO
