CREATE TABLE [dbo].[osida_info_keu_tdk_update_det]
(
...
GO
ALTER TABLE [dbo].[osida_info_keu_tdk_update_det] ADD CONSTRAINT [PK_osida_info_keu_tdk_update_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
