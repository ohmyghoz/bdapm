CREATE TABLE [dbo].[da_anomali_nilai_njop_agunan]
(
...
[dm_nilai_agunan_wajar] [decimal] (38, 6) NULL,
...
GO
ALTER TABLE [dbo].[da_anomali_nilai_njop_agunan] ADD CONSTRAINT [PK_da_anomali_nilai_njop_agunan] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
