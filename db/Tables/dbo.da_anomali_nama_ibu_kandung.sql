CREATE TABLE [dbo].[da_anomali_nama_ibu_kandung]
(
...
GO
ALTER TABLE [dbo].[da_anomali_nama_ibu_kandung] ADD CONSTRAINT [PK_da_anomali_nama_ibu_kandung] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
