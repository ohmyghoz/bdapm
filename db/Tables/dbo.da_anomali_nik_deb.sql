CREATE TABLE [dbo].[da_anomali_nik_deb]
(
...
GO
ALTER TABLE [dbo].[da_anomali_nik_deb] ADD CONSTRAINT [PK_da_anomali_nik_deb] PRIMARY KEY CLUSTERED ([rowid], [dm_bulan_data]) ON [PRIMARY]
GO
