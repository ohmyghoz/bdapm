CREATE TABLE [dbo].[osida_nik_tidak_konsisten_det]
(
...
GO
ALTER TABLE [dbo].[osida_nik_tidak_konsisten_det] ADD CONSTRAINT [PK_osida_nik_tidak_konsisten_det] PRIMARY KEY CLUSTERED  ([dm_periode], [rowid])
GO
